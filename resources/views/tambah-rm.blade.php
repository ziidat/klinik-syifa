        ...
        <form class="user" action="{{route('pasien.store')}}" method = "post">
          ...
          @endforeach
              ...
              <div class="form-group row">
                  ...
                  <input type="text" class="form-control " name="keluhan" value="{{Request::old('keluhan_utama')}}" required>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                  <label for="cekfisik">Pemeriksaan Fisik</label>
              ...
              <div class="form-group row">
                  ...
                  <select class="form-control " name="reseplist" id="reseplist" {{Auth::user()->profesi !== "Dokter" ? 'disabled="true"': ''}}>
                      ...
                      <option value="{{$obat->id}}">{{$obat->nama}} {{$obat->sediaan}} {{$obat->dosis}}{{$obat->satuan}}</option>
                      @endforeach
                  </select>   
                </div>
                  <div class="col-sm-3">
              ...
              @foreach ($idens as $iden)
                  <a href= "{{route('rm.index')}}" class="btn btn-danger btn-block" name="simpan">
