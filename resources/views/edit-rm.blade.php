    ...
    <div class="row">
        ...
        <input type="hidden" name="id" value="{{ $data->id }}">
            ...
            <div class="form-group row col-sm-12">
                ...
                <input type="text" class="form-control @error('keluhan') is-invalid @enderror" name="keluhan_utama" value="{{ $data->keluhan }}" required>
                @error('keluhan')
            ...
            <div class="form-group row col-sm-12  ">
                ...
                <textarea type="date" class="form-control @error('anamnesis') is-invalid @enderror" name="anamnesis"  required>{{ $data->anamnesis}}</textarea>
                @error('anamnesis')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group row">
                ...
                <textarea type="date" class="form-control @error('pemeriksaan') is-invalid @enderror" name="px_fisik" required>{{ $data->cekfisik }}</textarea>
                @error('pemeriksaan')
                    <span class="invalid-feedback" role="alert">
                         <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="col-sm-12 mb-3 mb-sm-0">
                <table width="75%" id="reseps">
                    ...
                    <tr>
                        ...
                        <td width="30%"><input type="text" name="resep[{{$i}}][nama]" value="{{get_value('obat',array_keys($data->allresep)[$i],'nama')}} {{get_value('obat',array_keys($data->allresep)[$i],'jenis')}} {{get_value('obat',array_keys($data->allresep)[$i],'dosis')}} {{get_value('obat',array_keys($data->allresep)[$i],'satuan')}}" class="form-control" readonly></td>
