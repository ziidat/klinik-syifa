    ...
    <div class="row">
        ...
        <input type="hidden" name="id" value="{{ $data->id }}">
            ...
            <div class="form-group row col-sm-12">
                ...
                <input type="text" class="form-control " name="keluhan_utama" value="{{ $data->keluhan }}" required>
            </div>
            <div class="form-group row col-sm-12  ">
            ...
            <div class="form-group row">
                ...
                <textarea type="date" class="form-control " name="px_fisik" required>{{ $data->cekfisik }}</textarea>
                </div>
            </div>
            <div class="form-group row">
              <div class="col-sm-6 mb-3 mb-sm-0">
