        ...
        <div class="col-md-4 align-items-center">
            <div class="row justify-content-center">
                ...
                <div class="profile-header-img">
                    <img width="250px" class="rounded-circle img-fluid" src="{{ asset('storage/avatars') }}/{{ old('avatar',$user->avatar) }}" 
                    <!-- badge -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="profesi" type="text" class="form-control @error('profesi') is-invalid @enderror" name="profesi" required>
                                    ...
                                    <option value="Petugas" {{$user->profesi == "Petugas" ? 'selected':''}}>Petugas</option>
                                    @error('profesi')
                                    <span class="invalid-feedback" role="alert"
                                    <strong>{{ $message }}</strong>
                                    </span>
